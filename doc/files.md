...
* umi.conf: contains configuration settings for umid or umi-qt
* umid.pid: stores the process id of umid while running
...
* debug.log: contains debug information and general logging generated by umid or umi-qt
