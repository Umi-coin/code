...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 8859
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 8860
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18859
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18860
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 8859
	%{_sbindir}/semanage port -d -p tcp 8860
	%{_sbindir}/semanage port -d -p tcp 18859
	%{_sbindir}/semanage port -d -p tcp 18860
