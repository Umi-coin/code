...
"""Verify that starting umi with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start umi with -h for help text")
        ...
        self.log.info("Start umi with -version for version information")
