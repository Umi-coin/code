...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The UMI Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "UMI Core"
...
#define PACKAGE_BUGREPORT "https://github.com/umi-project/umi/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "UMI Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "UMI Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "umi"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://umi.org/"
