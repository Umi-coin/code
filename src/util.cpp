...
const char * const BITCOIN_CONF_FILENAME = "umi.conf";
const char * const BITCOIN_PID_FILENAME = "umid.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "UMI";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/UMI";
#else
    // Unix
    return pathRet / ".umi";
#endif
