...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s umi-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  umi-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded umi transaction") + "\n" +
              "  umi-tx [options] -create [commands]   " + _("Create hex-encoded umi transaction") + "\n" +
              "\n";
