...
#if defined(NDEBUG)
# error "UMI cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "UMI Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s UMI additional fees, %d delta bytes\n",
