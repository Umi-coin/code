...
pkgdatadir = $(datadir)/umi
pkgincludedir = $(includedir)/umi
pkglibdir = $(libdir)/umi
pkglibexecdir = $(libexecdir)/umi
...
ACLOCAL = ${SHELL} /tmp/UMI/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /tmp/UMI/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/UMI/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/UMI/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = umi-cli
BITCOIN_DAEMON_NAME = umid
BITCOIN_GUI_NAME = umi-qt
BITCOIN_TX_NAME = umi-tx
...
COPYRIGHT_HOLDERS_FINAL = The UMI Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = UMI Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /tmp/UMI/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = umi
PACKAGE_BUGREPORT = https://github.com/umi-project/umi/issues
PACKAGE_NAME = UMI Core
PACKAGE_STRING = UMI Core 1.0.0
PACKAGE_TARNAME = umi
PACKAGE_URL = https://umi.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /tmp/UMI
abs_srcdir = /tmp/UMI
abs_top_builddir = /tmp/UMI
abs_top_srcdir = /tmp/UMI
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/UMI/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/UMI-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/UMI-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/UMI-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/UMI-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
